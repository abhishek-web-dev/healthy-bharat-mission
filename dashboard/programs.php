...
<head>
    ...
    <title>My Programs - Healthy Bharat Mission</title>
            ...
            <div id="dashboard-main" class="flex-1 transition-opacity duration-300 opacity-0 min-w-0">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-heading font-bold text-gray-800">My Programs</h2>
                            <p class="text-gray-500 text-sm mt-0.5">Track your enrolled programs and continue your journey towards a healthier you.</p>
                        </div>
                    </div>
                    <div class="bg-green-50/50 border border-green-100 rounded-xl px-5 py-3 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-[13px] font-bold text-[#106e39]">"Consistency today, a healthier tomorrow."</p>
                ...
                <div class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 text-lg">Explore More Programs</h3>
                            <p class="text-gray-500 text-sm mt-0.5">Discover new programs to support your health goals.</p>
                        </div>
                    </div>
                    <a href="../program" class="px-5 py-2.5 border border-[#106e39] text-[#106e39] rounded-lg font-bold hover:bg-green-50 transition-colors whitespace-nowrap">Browse All Programs</a>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    tabs.forEach(t => {
                        if (t === tab) {
                            t.className = "px-6 py-3 font-bold text-[#106e39] border-b-2 border-[#106e39] outline-none";
                        } else {
                            t.className = "px-6 py-3 font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent outline-none";
                        }
                    });
