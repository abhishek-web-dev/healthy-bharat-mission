...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <h2 class="text-2xl font-bold text-gray-800">Add Health Condition</h2>
        <p class="text-sm text-gray-500 mt-1">Create a new health condition for the library.</p>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    <form id="condition-form" class="p-6 space-y-6">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const slugInput = document.getElementById('condition-slug');
