...
<head>
    ...
    <title>Forgot Password - Healthy Bharat Mission</title>
    <!-- Google Fonts -->
...
<body
    ...
    <div
        ...
        <div class="hidden lg:block lg:w-[45%] relative bg-[#f4f7f5] shrink-0 overflow-hidden">
            ...
            <div class="absolute inset-0"
                style="background: linear-gradient(to bottom, rgba(255,255,255,0) 60%, rgba(0,43,20,0.5) 100%);"></div>
            ...
            <div class="relative z-10 w-full h-full p-8 xl:p-12 flex flex-col">
                ...
                <h1 class="text-[32px] xl:text-[40px] font-extrabold text-[#052b14] leading-[1.1] mb-5 tracking-tight">
                    Reset Today<br>for a <span class="text-[#106e39]">Brighter<br>Tomorrow</span>
                </h1>

                <!-- Subtitle -->
                <p class="text-gray-800 text-[14px] xl:text-[15px] max-w-[320px] mb-8 leading-relaxed font-semibold">
                    Forgot your password? No worries.<br>We'll help you get back to your account quickly and securely.
                </p>
                ...
                <div class="space-y-4 max-w-[320px]">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <span class="text-[14px] xl:text-[15px] font-bold text-[#052b14] leading-tight block">Secure & Private</span>
                            <span class="text-[13px] text-gray-500 mt-0.5 block font-medium">Your data is always protected</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <span class="text-[14px] xl:text-[15px] font-bold text-[#052b14] leading-tight block">Expert Support</span>
                            <span class="text-[13px] text-gray-500 mt-0.5 block font-medium">We're here to help</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <span class="text-[14px] xl:text-[15px] font-bold text-[#052b14] leading-tight block">Continue Your Journey</span>
                            <span class="text-[13px] text-gray-500 mt-0.5 block font-medium">Your health goals await</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <span class="text-[14px] xl:text-[15px] font-bold text-[#052b14] leading-tight block">Trusted Platform</span>
                            <span class="text-[13px] text-gray-500 mt-0.5 block font-medium">For a healthier you</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full lg:w-[55%] flex flex-col p-6 sm:p-8 lg:p-10 xl:p-12 relative">
            ...
            <div class="w-full max-w-[440px] mx-auto flex-grow flex flex-col justify-center">
                <h1 class="text-3xl md:text-[38px] font-extrabold text-[#052b14] mb-2 tracking-tight">Forgot <span
                        class="text-[#106e39]">Password?</span></h1>

                <p class="text-gray-500 text-[14px] mb-8 leading-relaxed font-medium">Enter your registered email address and we'll send you a verification code to reset your password.</p>
                ...
                <form>
                    ...
                    <button type="submit" style="padding-top: 14px; padding-bottom: 14px; font-size: 16px;"
                        class="w-full flex items-center justify-center bg-[#052b14] hover:bg-[#1a5c2e] text-white font-bold px-4 rounded-xl shadow-[0_4px_12px_rgba(5,43,20,0.15)] transition-all mt-8">
                        Send Verification Code <i class="fa-solid fa-arrow-right ml-2 text-[13px]"></i>
                    </button>
                    ...
                    <div class="bg-[#f0f8f3] rounded-xl p-4 flex gap-4 mt-6 items-start border border-green-50">
                        ...
                        <div>
                            ...
                            <p class="text-[12.5px] text-gray-500 mt-0.5 font-medium">We use industry-standard security to protect your information.</p>
                        </div>
                    </div>
                </form>
            </div>
