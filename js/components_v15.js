                ...
                <div class="p-6 overflow-y-auto custom-scrollbar">
                    <form id="modal-contact-form" class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="modal-contact-phone" placeholder="Phone Number"
                                class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-primary focus:border-primary focus:bg-white outline-none transition-all">
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <select id="modal-contact-subject" required class="w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-primary focus:border-primary focus:bg-white outline-none transition-all appearance-none text-gray-600">
                                <option value="" disabled>Select a Subject *</option>
                                <option value="programs">Programs & Courses</option>
                                <option value="consultation" selected>Book Consultation</option>
                                <option value="partnership">Partnership Inquiry</option>
                                <option value="other">Other</option>
                            </select>
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
